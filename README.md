...
This is the theme that powers the 2019 edition of https://haacked.com/. It's a loose mashup of the [Minima theme](https://github.com/jekyll/minima) for Jekyll and the [Greyshade theme](https://github.com/shashankmehta/greyshade) for Octopress.
...
And copy all the relevant [settings from the theme's `_config.yml`](https://github.com/Haacked/haacked.com-theme/blob/master/_config.yml). You'll want to hange the values to reflect your website, unless your name just happens to be "Blog Author."
...
```bash
git clone https://github.com/haacked/haacked.com-theme
cd haacked.com-theme
script/bootstrap
script/server
```
